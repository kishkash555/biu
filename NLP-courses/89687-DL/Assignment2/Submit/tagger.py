...
if __name__ == "__main__":
    ...
    if 'O' in tag_dict:
        very_common_tag = tag_dict['O']
        print('common tag code: {}'.format(very_common_tag))
    else:
        very_common_tag = -1  
    ntags = len(tag_dict)
    with open(input_file,'rt') as i:
    ...
    try:
        for i in range(10):
            ...
            mlp.train_network(params, ntags, train_data, dev_set,telemetry_file, randstring, very_common_tag)
